...
export const BrainPlaceholder = ({ onLobeClick, hoveredLobe, setHoveredLobe }: BrainPlaceholderProps) => {
    ...
    return (
        <group>
            ...
            <LobeSphere position={[2, -1.5, -1]} color="#f472b6" name="Hippocampus" path="hippocampus" hoveredLobe={hoveredLobe} setHoveredLobe={setHoveredLobe} onLobeClick={onLobeClick} />
            <LobeSphere position={[-1.5, -2, -2]} color="#fbbf24" name="Hypothalamus" path="hypothalamus" hoveredLobe={hoveredLobe} setHoveredLobe={setHoveredLobe} onLobeClick={onLobeClick} />
